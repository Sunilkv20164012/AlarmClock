 ...
 */
package com.example.sunil.alarmclock.alert;
...
import com.example.sunil.alarmclock.Alarm;
import com.example.sunil.alarmclock.NotificationActivity;
	...
	public void onClick(View v) {
		...
		if(v.getId()==R.id.snooze)
		{
			...
			calendar.setTimeInMillis(System.currentTimeMillis());
				...
				AlarmManager AlmMgr = (AlarmManager)getApplicationContext().getSystemService(Context.ALARM_SERVICE);
				PendingIntent Sender = PendingIntent.getBroadcast(AlarmAlertActivity.this, 0, AlarmIntent, 0);
				AlmMgr.set(AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), Sender);
			Toast.makeText(AlarmAlertActivity.this,"dufnd",Toast.LENGTH_LONG).show();
